...
<body>
    ...
    <?php
        // redirect to home and prevent from going to register if login-ed
    ...
    <div class="login">
        ...
        <form class="needs-validation" action="/backend/process-register.php" method="post" novalidate>
            <div class="row name">
            ...
            <div class="form-group">
                ...
                <input class="form-control" type="date" name="bday" placeholder="dd-mm-yyyy" min="1997-01-01" max="<?php echo date('Y-m-d'); ?>"
