        ...
        <div class="col-2 logo">
                    ...
                    <ul class="navbar-nav e-commerce-font-color">
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <ul class="dropdown-menu category">
                                <li><a class="dropdown-item" href="t-shirt-category.php">T-Shirts</a></li>
            ...
            <div class="col-3">
                <div class="d-flex align-items-center">
                    ...
                    <button class="btn bg-transparent" type="submit"><img src="/images/navbar-images/search.png" alt="search" width="40px"></button>
            ...
            <div class="col-2">
                <button class="btn btn-nav px-4"><img src="/images/navbar-images/cart.png" alt="cart" width="40px"></button>
