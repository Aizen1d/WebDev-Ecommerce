            ...
            <div class="col left">
                ...
                <div class="row">
                    <div class="col-6 form-group">
                        ...
                        <input readonly class="form-control-plaintext" type="firstname" id="firstname" value="Nom" required>
                    ...
                    <div class="col-6 form-group">
                        ...
                        <input readonly class="form-control-plaintext" type="lastname" id="lastname" value="Nomi" required>
                        <div class="invalid-feedback">
            ...
            <div class="col right">
                ...
                <form class="voucher">
                    <div class="input-group">
                        <input type="text" readonly class="form-control-plaintext" placeholder="Voucher Code" value="SAVE10OFF">
                    </div>
                </form>
