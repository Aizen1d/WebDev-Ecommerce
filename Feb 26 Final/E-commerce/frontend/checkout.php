...
<body>
    ...
    <form action="/frontend/receipt.php" method="post" id="place-order-form">
        ...
        <input type="hidden" id="voucher-input" name="voucher-input" value="">
    </form>
        ...
        <div class="row">
            ...
            <script>
                ...
                function validateForm() {
                    ...
                    document.getElementById("phone-number-input").value = document.getElementById("phonenumber").value 
                    ...
                    <?php 
                        if (isset($_SESSION['voucherCode'])) {
                            echo "document.getElementById('voucher-input').value = '{$_SESSION['voucherCode']}'";
                        } 
                        else {
                            echo "document.getElementById('voucher-input').value = 'No voucher'";
                        }
